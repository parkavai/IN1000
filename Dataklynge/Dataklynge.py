...
class Datasenter:
    ...
    def lesInnRegneklynge(self, filnavn):
        ...
        self._regneklyngeordbok[filSplit[0]] = []
        for linje in fil:
    ...
    def skrivUtAlleRegneklynger(self):
        for nokkel in self._regneklyngeordbok.keys():
            ...
            print(f"Antall noder: {regneklynge.noderMedNokMinne} \n")
...
class Regneklynge:
    ...
    def noderMedNokMinne(self, paakrevdMinne):
        antNoder = 0
        for rack in self._rackliste:
            antNoder += rack.noderMedNokMinne()
        return antNoder
